import { getConfigPath, loadConfig, type ConfigFs } from "../src/config.js";
import { DEFAULT_CONFIG } from "../src/types.js";
import { describe, expect, it } from "vitest";

describe("getConfigPath", () => {
  it("resolves under the agent directory", () => {
    expect(getConfigPath("/agent")).toBe(
      "/agent/notification-center/config.json",
    );
  });
});
