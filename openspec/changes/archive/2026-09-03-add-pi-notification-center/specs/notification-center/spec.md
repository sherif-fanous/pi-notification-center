...
- **WHEN** a notification contains multiple lines or exceeds the configured
  toast width
...
- **WHEN** the terminal is too narrow or short for the configured toast
  presentation
...
containing `timeout`, `maxLines`, and `width`. Defaults SHALL be 5 visible
toasts, 3000 milliseconds, 5 body rows, and 50 columns.
